...
import pl.bartlomiejstepien.battleship.board.BattleshipBoard;
...
public class BattleshipGame extends Application
{
    ...
    public void start(Stage primaryStage) throws Exception
    {
        ...
        this.battleshipBoard = new BattleshipBoard(50, 50, 500);
        this.group.getChildren().add(this.battleshipBoard);
